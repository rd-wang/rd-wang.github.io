...
有关更多信息，请参阅 [重写方法时，使用类型安全的返回值](https://rd-wang.github.io/posts/Dart变量/#重写方法时，使用类型安全的返回值) 以及 [重写方法时，使用类型安全的参数](https://rd-wang.github.io/posts/Dart变量/#重写方法时，使用类型安全的参数)。
