...
库可以通过包来分发。有关 pub（集成在SDK中的包管理器）的信息，请参考 [在pub上发布自己的库](https://rd-wang.github.io/posts/Flutter发布公用库/)。
...
```
在前面的代码，使用 await 关键字暂停代码执行一直到库加载完成。 关于 async 和 await 的更多信息请参考 [Dart 异步](https://rd-wang.github.io/posts/Dart异步/)。
...
#### 实现库
有关如何实现库包的建议，请参考 我的另一篇文章 [在pub上发布自己的库](https://blog.csdn.net/rd_w_csdn/article/details/103390176)。或者请参考 [Create Library Packages](https://www.dartcn.com/guides/libraries/create-library-packages) 这里面包括：
