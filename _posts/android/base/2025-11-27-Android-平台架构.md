...
date: 2025-11-27 14:01:52 +0800
categories:
  - Android
tags:
  - Android
  - Architecture
description: "平台架构\r\r：\rAndroid 是一个基于 Linux 的开源软件堆栈。"
math: true
---
...
Android 是一个基于 Linux 的开源软件堆栈， Android 平台的主要组件如下图所示。
![The Android software stack](https://developer.android.com/static/guide/platform/images/android-stack_2x.png){:width="50%",height="50%"}
_Android 软件堆栈_
